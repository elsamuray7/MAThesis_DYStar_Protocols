...
let serialize_encval i ev l =
  ...
  | EncMsg1 n_a c a b ->
    ...
    (|"ev1",(LC.concat #oyrs_global_usage #i #l n_a (LC.concat #oyrs_global_usage #i #l c (LC.concat #oyrs_global_usage #i #l a_bytes b_bytes)))|)
  | EncMsg2 n_b c a b ->
    let a_bytes = LC.string_to_bytes #oyrs_global_usage #i a in
    let b_bytes = LC.string_to_bytes #oyrs_global_usage #i b in
    (|"ev2",(LC.concat #oyrs_global_usage #i #l n_b (LC.concat #oyrs_global_usage #i #l c (LC.concat #oyrs_global_usage #i #l a_bytes b_bytes)))|)
  | EncMsg3_I n_a k_ab ->
